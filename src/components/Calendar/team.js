...
export class Team extends Component {
    ...
    generateTeam() {
        this.teamHeaderContext = new TeamRowComponent(this.component, this.teamData, this.daysInCurrentMonth, this.date, this.hideTable.bind(this));
    ...
    hideTable(e) {
        ...
        if (e.target.classList.contains("hiddenEmployees")) {
            ...
            functionWeShouldUse = functionWeShouldUse = this.hide;
        }
